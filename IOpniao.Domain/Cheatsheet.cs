...
namespace Examplinvi
{
    ...
    class Program
    {
        ...
        static void Main()
        {
            TwitterCredentials.SetCredentials("367702835-W2noqZPakgL5CIsntVCLBSwlGdBvRhgTgGVPMzRw",
                "rP37veFKD86BMtzHjXVoa5TFO1s7P4rzYbfMf3WrHv1jZ",
                "JZx4kJDdA3G2GLjSaD2FmEY63",
                "LkMXK9eYllZcPLTOpAq2EwTnYYLH8IFDzYPA6gQ5GgLKbab7T1");
        ...
        {
            //var tweets = Search.SearchTweets("testehenrique");
            var stream = Stream.CreateFilteredStream();
            //stream.AddTrack("testehenrique", testeHenrique);
            stream.AddTrack("testehenrique", testeHenrique);
        ...
        private static void testeHenrique(ITweet tweet)
        {
            Console.WriteLine("Opa funfou" + tweet.Text);
        }
